...
namespace MvcIdentityRolesEmpleados.Repositories
{
    public class RepositoryEmpleado
    {
        ...
        //NECESITAMOS UN METODO PARA COMPROBAR SI EXISTE UN EMPLEADO POR SU USUARIO (APELLIDO) Y PASSWORD (EMP_NO)

        public Empleado ExisteEmpleado(string apellido, int idempleado)
        {
            var consulta = from datos in this.context.Empleados where
                           datos.Apellido== apellido && datos.IdEmpleado== idempleado
                           select datos;
